-- Migration: 210_fix_ocr_referencia_pago_parcial.sql
-- Description: Arregla el bug que borraba el sufijo " | Pago Parcial" de la referencia cuando se usaba OCR o auto-verificaba un pedido mixto, lo que causaba confusión visual en el panel de admin al no mostrar la billetera usada.
