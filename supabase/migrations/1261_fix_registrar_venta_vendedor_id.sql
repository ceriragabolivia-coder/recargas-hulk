-- Migration: 126_fix_registrar_venta_vendedor_id.sql
-- Description: Corregir registrar_venta_rpc para entregas automáticas, mapeando el SuperAdmin al ID de la tabla public.clientes en lugar del ID de auth.users, evitando violaciones de clave foránea.
