-- Migración 194: Actualizar RPC unificado para procesar webhooks de TiendaGiftVen
-- Agrega más estados aceptados como completado para mayor flexibilidad (ej. exitoso, procesado, realizado).
