-- Migration 092: Solución definitiva a la ambigüedad en reembolsar_pedido_rpc
-- Este parche elimina todas las versiones duplicadas de la función de reembolso
-- para resolver el error 'Could not choose the best candidate function'.

-- 1. LIMPIEZA DE FUNCIONES DUPLICADAS
-- Esto elimina cualquier versión previa (sea con ID integer o uuid) para empezar de cero
DO $$ 
DECLARE 
    r RECORD;
BEGIN
...
-- 2. RECREACIÓN DE LA FUNCIÓN (Versión UUID unificada)
