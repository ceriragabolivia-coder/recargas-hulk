-- Migración 151: Actualizar RPC para permitir motivo_estado
...
BEGIN
    ...
    INSERT INTO public.perfiles (id, rol, estado, porcentaje_descuento, config_modulos, motivo_estado, updated_at)
    VALUES (p_user_id, p_rol, COALESCE(p_estado, 'aprobado'), p_porcentaje_descuento, p_config_modulos, p_motivo, now())
