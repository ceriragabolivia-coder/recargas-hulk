-- ============================================
-- MIGRATION: Update validar_cupon_rpc to save coupon to user's wallet
-- ============================================
...
BEGIN
    ...
    -- Guardar el cupón en la sección "Mis Cupones" del usuario con 0 usos si no lo tiene guardado
