        ...
        <nav className="sidebar-nav">
          {isAdmin ? (
            <>
              ...
              {NAV_ITEMS.filter(i => ['productos', 'pedidos', 'usuarios', 'revendedores', 'chats', 'proveedor_tgv', 'pagos_admins', 'pagos_apk', 'gestion_socios', 'config', 'gestion_landing', 'gestion_paginas', 'gestion_cupones', 'gestion_creadores', 'interfaces_admin', 'sorteos'].includes(i.key)).map(renderNavItem)}
