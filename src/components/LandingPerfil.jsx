                                ...
                                return (
                                  <div key={obj.id} style={{ background: 'var(--bg-card)', borderRadius: '12px', padding: '12px', border: '1px solid var(--border)' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                                      ...
                                      {canjeado ? (
                                        <span style={{ fontSize: '11px', background: 'rgba(0, 200, 83, 0.1)', color: '#00c853', padding: '4px 8px', borderRadius: '8px', fontWeight: 'bold' }}>✓ RECLAMADO</span>
                                      ) : alcanzado ? (
                                        <button 
                                    ...
                                    {!canjeado && (
                                      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '12px' }}>
                                        ...
                                        <div>
                                          ...
                                          <div style={{ width: '100%', height: '6px', background: 'var(--bg-hover)', borderRadius: '4px', overflow: 'hidden' }}>
                                        ...
                                        <div>
                                          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', color: 'var(--text-muted)', marginBottom: '4px' }}>
                                            ...
                                            <span style={{ fontWeight: alcanzado ? 'bold' : 'normal', color: alcanzado ? '#00c853' : 'inherit' }}>{referidosValidos} / {obj.meta_registros}</span>
                                          </div>
                                          <div style={{ width: '100%', height: '6px', background: 'var(--bg-hover)', borderRadius: '4px', overflow: 'hidden' }}>
                                            <div style={{ height: '100%', width: `${progresoCompras}%`, background: alcanzado ? '#00c853' : 'var(--accent)', transition: 'width 0.5s ease' }}></div>
                                          </div>
                                        </div>
                                      </div>
                                    )}
