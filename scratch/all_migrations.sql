...
NOTIFY pgrst, 'reload schema';
-- Migration 129: Revertir asignaciÃ³n de cÃ³digos en reembolso
-- Oculta los cÃ³digos al usuario y los devuelve al baÃºl cuando se reembolsa el pedido a billetera
...
BEGIN
    ...
    IF p_cambiar_estado THEN
        ...
        -- 6.1. Revertir cÃ³digos asignados para que vuelvan al baÃºl
        UPDATE public.producto_codigos
        SET usado = FALSE,
            pedido_id = NULL,
            usado_at = NULL
        ...
        -- 6.2. Ocultar los cÃ³digos en los items del pedido
        UPDATE public.pedido_items
    ...
    IF p_moneda = 'bs' THEN
        v_noti_msg := 'Se te han reembolsado ' || v_refund_amount || 'Bs a tu Billetera BolÃ­vares correspondiente al pedido #' || LPAD(v_pedido.numero_pedido::TEXT, 6, '0') || '.';
    ELSE
        v_noti_msg := 'Se te han reembolsado $' || v_refund_amount || ' a tu Billetera DÃ³lares correspondiente al pedido #' || LPAD(v_pedido.numero_pedido::TEXT, 6, '0') || '.';
    END IF;
